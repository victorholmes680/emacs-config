;;; ipretty-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Ipretty mode' mode.  If the prefix argument is positive, enable the
