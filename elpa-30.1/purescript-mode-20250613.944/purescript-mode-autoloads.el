...
(register-definition-prefixes "purescript-font-lock" '("purescript-"))
...
`Purescript-Indentation mode' mode.  If the prefix argument is positive,
...
evaluate the variable `purescript-indentation-mode'.
...

;;; Generated autoloads from purescript-vars.el

(register-definition-prefixes "purescript-vars" '("purescript-literate"))
...
(fn &rest ARGS)")
(register-definition-prefixes "purescript-yas" '("purescript-yas-completing-function"))

;;; End of scraped data
